...
if __name__ == '__main__':
    ...
    #               wordname_15)
    # DOTA2COCOTest(r'/media/ubuntu/data/huojianjun/科目四初赛第一阶段/test',
    #               r'/media/ubuntu/data/huojianjun/科目四初赛第一阶段/test/testA.json',
    #               project_4)
    DOTA2COCOTrain(r'/media/ubuntu/data/huojianjun/科目四初赛第一阶段/test2',
                   r'/media/ubuntu/data/huojianjun/科目四初赛第一阶段/test2/test2.json',
                   project_4)
