...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'train_all/train_all.json',
        img_prefix=data_root + 'train_all/images/',
        img_scale=(1024, 1024),
...
log_level = 'INFO'
work_dir = './work_dirs/faster_rcnn_RoITrans_r50_fpn_1x_dota1_5_gap512_msTrainTest_rotationTrainTest'
load_from = "./checkpoint/epoch_12.pth"
resume_from = None
workflow = [('train', 1)]
